...
class MoELLaVAPhiModel(LlavaMetaModel, PhiModel):
...
AutoModelForCausalLM.register(MoELLaVAPhiConfig, MoELLaVAPhiForCausalLM)

AutoModelForCausalLM.register(MoELLaVAPhiConfig, EvalMoELLaVAPhiForCausalLM)
